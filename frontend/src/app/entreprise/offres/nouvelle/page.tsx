...
export default function NouvelleOffrePage() {
  ...
  const handleSubmit = async () => {
    ...
    setError("");
    try {
      const res = await offresApi.create({
        ...form,
      ...
      router.push(`/entreprise/offres/${res.data.id_offre}/candidats`);
    } catch (err: any) {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Publier une nouvelle offre</h1>
      <p className="text-gray-500 text-sm mb-6">
        Répondez aux questions pour que nous trouvions les meilleurs profils pour vous.
      </p>
      ...
      <div className="card space-y-4">
        ...
        {step === 1 && (
          <>
            <p className="text-sm text-gray-500">
              Quel diplôme et quelle filière recherchez-vous chez le/la candidat(e) idéal(e) ?
            </p>
            <div>
        ...
        {step === 2 && (
          <>
            <p className="text-sm text-gray-500">
              Sélectionnez les compétences nécessaires et leur importance pour le matching.
            </p>
